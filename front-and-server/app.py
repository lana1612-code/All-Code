...
order_db_path = os.path.join(os.path.dirname(__file__), '../order/order.db')
catalog_db_path = os.path.join(os.path.dirname(__file__), '../catalog/catalog.db')

@app.route('/')  
def home():  
    return "Front service is running!" 
